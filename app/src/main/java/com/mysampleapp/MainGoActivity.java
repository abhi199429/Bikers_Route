...
public class MainGoActivity extends AppCompatActivity {
    ...
    public static final String DEFAULT_PATH = "/useRoute";
...
// client to send the request.
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        res = (TextView) findViewById(R.id.resultroutes);
...
//take response and DISPLAY IT
    ...
    private void setResponseBodyText(final String text) {
        ...
        ThreadUtils.runOnUiThread(new Runnable() {
            ...
            @Override
            public void run() { res.setText(text);}
